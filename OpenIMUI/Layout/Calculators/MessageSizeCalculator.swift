...
open class MessageSizeCalculator: CellSizeCalculator {
    ...
    open override func configure(attributes: UICollectionViewLayoutAttributes) {
        ...
        attributes.orientation = dataSource.isFromCurrentSender(message: message) ? .outgoing : .incoming
    ...
    open func messageContainerMargin(for message: MessageType, at indexPath: IndexPath) -> UIEdgeInsets {
        ...
        return isFromCurrentSender ? outgoingMessageMargin : incomingMessageMargin
    }
