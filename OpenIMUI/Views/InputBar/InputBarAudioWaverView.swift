...
public class InputBarAudioWaverView: UIView {
    ...
    private var callback: ((_ waver: InputBarAudioWaverView) -> Void)?
    func setWaverLevel(callback: @escaping (_ waver: InputBarAudioWaverView) -> Void) {
