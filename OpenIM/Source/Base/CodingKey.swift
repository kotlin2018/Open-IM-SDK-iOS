...
public struct LowercasedFirstLetterCodingKey: CodingKey {
    ...
    public init?(stringValue: String) {
        ...
        let startIndex = self.stringValue.startIndex
        let endIndex = self.stringValue.index(startIndex, offsetBy: stringValue.count > 2 ? 2 : 1)
        self.stringValue.replaceSubrange(startIndex...endIndex,
